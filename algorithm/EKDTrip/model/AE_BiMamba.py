...
class BiMamba(nn.Module):
    def __init__(self, d_model, d_intermediate, vocab_size, expand, conv_dim, tem_depth, p_dropout):
        super().__init__()
        ...
        self.mlp = nn.Sequential(
            nn.Linear(d_model + 32 + 2*32, d_model + 32 + 2*32),
            nn.LayerNorm(d_model + 32 + 2*32),
            nn.LeakyReLU(),
    ...
    def forward(self, x, context, x_delta=None):
        '''
